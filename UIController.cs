...
public class UIController : MonoBehaviour
{
    ...
    public void FindAllItems()
    {
        ...
        XmlNodeList items = itemDataXml.SelectNodes("/ItemsInventarios/ItemsInventario");
    ...
    public void FindItemsOfType(string itemType)
    {
        ...
        XmlNodeList items = itemDataXml.SelectNodes("/ItemsInventarios/ItemsInventario[@Type='" + itemType + "']");
    ...
    {
        XmlNode curNode = itemDataXml.SelectSingleNode("/ItemsInventarios/ItemsInventario[@ID='" + itemID + "']");
        if (curNode == null)
        {
    ...
    class InventoryItem
    {
        ...
        public InventoryItem(XmlNode curItemNode)
        {
            ...
            itemDescription = curItemNode["DescripcionItem"].InnerText;
